...
/* harmony import */ var _components_scroll_up__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/scroll-up */ "./src/js/components/scroll-up.js");
/* harmony import */ var _components_scroll_up__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_components_scroll_up__WEBPACK_IMPORTED_MODULE_0__);
...
/***/ "./src/js/components/scroll-up.js":
/*!****************************************!*\
  !*** ./src/js/components/scroll-up.js ***!
  \****************************************/
/***/ (() => {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const thimbSliderWrapper = document.querySelector(".thimb-slider .swiper-wrapper");
  ...
  slidesCaptions?.forEach(function (title, i) {
    thimbSliderWrapper.insertAdjacentHTML("beforeend", `<div class="swiper-slide thimb-slide">
        ${title.innerHTML}
                </div>`);
  });
